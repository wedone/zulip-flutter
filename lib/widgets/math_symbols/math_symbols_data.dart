...
const kMathSymbols = <MathSymbolCategory, List<MathSymbolItem>>{
  ...
  MathSymbolCategory.functions: [
    // 三角函数
    LatexSnippet(display: 'sin',    output: '\\sin',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'cos',    output: '\\cos',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'tan',    output: '\\tan',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'cot',    output: '\\cot',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'sec',    output: '\\sec',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'csc',    output: '\\csc',    cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'arcsin', output: '\\arcsin', cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'arccos', output: '\\arccos', cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'arctan', output: '\\arctan', cursorOffset: 0, category: MathSymbolCategory.functions),
    // 对数+极限
    LatexSnippet(display: 'log', output: '\\log', cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'ln',  output: '\\ln',  cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'lg',  output: '\\lg',  cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'lim', output: '\\lim', cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'max', output: '\\max', cursorOffset: 0, category: MathSymbolCategory.functions),
    LatexSnippet(display: 'min', output: '\\min', cursorOffset: 0, category: MathSymbolCategory.functions),
    // 微积分符号
