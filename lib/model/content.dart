...
/// A complete math expression within Zulip content,
...
sealed class MathNode extends ContentNode {
  ...
  @override
  bool operator ==(Object other) {
    return other is MathNode && other.texSource == texSource;
  }

  @override
  int get hashCode => Object.hash('MathNode', texSource);
...
class InlineSvgNode extends ContentNode implements InlineContentNode {
  const InlineSvgNode({
  ...
  @override
  bool operator ==(Object other) {
    return other is InlineSvgNode && other.svgSource == svgSource;
  }

  @override
  int get hashCode => Object.hash('InlineSvgNode', svgSource);

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(StringProperty('svgSource', svgSource));
  }
}
...
class _ZulipContentParser {
  ...
  void parseMathBlocks(dom.NodeList nodes, List<BlockContentNode> result) {
    ...
    final texSource = parseMath(firstChild, block: true);
    if (texSource != null) {
