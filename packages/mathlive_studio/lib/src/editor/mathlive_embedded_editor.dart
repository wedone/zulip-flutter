...
class _MathLiveEmbeddedEditorState extends State<MathLiveEmbeddedEditor> {
  ...
  /// mathlive 资源 base URL：Android 使用本地 asset，其他平台回退 CDN。
  String get _mathliveBaseUrl {
    if (defaultTargetPlatform == TargetPlatform.android) {
      return 'file:///android_asset/flutter_assets/packages/mathlive_studio/assets/mathlive/';
    }
    return 'https://cdn.jsdelivr.net/npm/mathlive@0.110.0/';
  }
